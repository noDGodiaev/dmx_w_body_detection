...
if __name__ == "__main__":
    ...
    # cap = cv2.VideoCapture('rtsp://172.18.191.160:554/12')
    ...
    while cv2.waitKey(1) < 1:
        ...
        if framecount % 3 == 0:
            ...
            for (classid, score, box) in zip(classes, scores, boxes):
                ...
                xindexlist.append(xind)
                yindexlist.append(yind)
                color = (255, 0, 0)
            ...
            # set_single_value(channel, value)
            artnet.set_single_value(1, 255)
